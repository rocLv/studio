! function() {
  for (var e, t = document.getElementsByTagName("pre"), o = 0; o < t.length; o++)
    0 === t[o].children[0].className.indexOf("language-") && ((e = document.createElement("button")).className = "copy-button",
      e.textContent = "Copy",
      t[o].appendChild(e));
...
$(document).ready(function() {
  var e;
  $(".menu-list").length && $(".menu-list").slimScroll({
      height: "100%"
    }),
    $(".header").length && $(window).scroll(function() {
      200 < $(".header").offset().top ? $(".header").addClass("header-collapse") : $(".header").removeClass("header-collapse")
    }),
    ...
    $("#scroll-nav a ").length && $("#scroll-nav a").on("click", function() {
    ...
    $(".sidebar-nav-fixed a").length && $(".sidebar-nav-fixed a").click(function(e) {
      var t;
    ...
    $("#program-date").length && new Litepicker({
      element: document.getElementById("program-date")
    }),
    $("#mapid").length && (e = L.map("mapid").setView([51.505, -.09], 13),
    ...
    $("#price_ranger").length && $("#price_ranger").ionRangeSlider({
      type: "double",
      grid: !0,
      min: 0,
      max: 40,
    ...
    $('[href="#"]').length && document.querySelectorAll('[href="#"]').forEach(function(e) {
